...
<Card title="Stripe" icon="dollar-sign" href="/essentials/stripe">
...
<Card title="Website Scrapper" icon="webhook" href="/essentials/website-scrapper">
 **Website scraper** integrations facilitate the extraction of specific data sections and bulk data collection from multiple sites, enabling efficient analysis and reporting in Google Sheets or Docs.
</Card>
