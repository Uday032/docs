...
```
{
    "websiteURL": "" // the url of the site that you want to scrape,
    "extractClassName": "" // the className of the url you want to scrape,
    "onClickClassName: "" // If it contain pagination, the button to move to next cards
}
```
...
```
It will extract all the details and provide the output in the markdown format.
```
